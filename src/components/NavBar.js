...
import {
  ...
  SunIcon,
  MoonIcon,
} from './Icon'; // Adjust the path as per your project structure
    ...
    <header className="w-full px-32 py-8 font-medium flex items-center justify-between dark:text-light relative">
      ...
      <div className="w-full flex justify-between items-center lg:hidden">
        <nav>
          ...
          <CustomLink href="/articles" title="Case Studies" className="ml-4" />
        </nav>
        <nav className="flex items-center justify-center flex-wrap">
          <motion.a
            href="https://github.com/Dibakar58"
            target="_blank"
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
            className="w-6 mr-3"
...
*/}
          ...
          <motion.a
            href="https://www.linkedin.com/in/dibakar-chaudhary/"
            target="_blank"
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
            className="w-6 mx-3"
